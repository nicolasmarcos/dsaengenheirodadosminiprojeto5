...
spark = (
    SparkSession
    .builder
    .appName("CargaBronzeIncrementalCustomerAddress")
...
# dfOrigin.show()
dfTarget = spark.read.parquet("hdfs:///user/hadoop/miniprojeto5/bronze/customeraddress")
# dfTarget.show()
...
matchClause = [dfOrigin["customerid"] == dfTarget["customerid"], dfOrigin["addressid"] == dfTarget["addressid"], dfOrigin["modifieddate"] == dfTarget["modifieddate"]]
